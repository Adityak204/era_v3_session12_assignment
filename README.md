...
Sample text generated by the model: ![image](docs/sample_prediction.png)

## HuggingFace Space
The model is available on HuggingFace space. You can access the model using the following link: [Julius-Caesar-Play-GPT](https://huggingface.co/spaces/Adityak204/JuliusCaesarGPT)
Screenshot from the HuggingFace space: ![image](docs/hf_screenshot.png)
